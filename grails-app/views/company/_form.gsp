...
<div class="fieldcontain ${hasErrors(bean: companyInstance, field: 'persons', 'error')} ">
	...
	<g:select name="persons" from="${compo.Person.list()}" multiple="multiple" optionKey="id" size="5" value="${companyInstance?.persons*.id}" class="many-to-many"/>
