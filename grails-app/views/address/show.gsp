	...
	<body>
		...
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.code}">
				<li class="fieldcontain">
					<span id="code-label" class="property-label"><g:message code="address.code.label" default="Code" /></span>
					
						<span class="property-value" aria-labelledby="code-label"><g:fieldValue bean="${addressInstance}" field="code"/></span>
